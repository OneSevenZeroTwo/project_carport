	...
	template: `
		<div class="weui-tab">
		    ...
		    <div class="weui-tabbar">
		        <a href="javascript:;" @click="changTab(0)" :class="{'weui-bar__item_on':tabbar==0}" class="weui-tabbar__item">
		        ...
		        <a href="javascript:;" @click="changTab(3)" :class="{'weui-bar__item_on':tabbar==3}" class="weui-tabbar__item">
